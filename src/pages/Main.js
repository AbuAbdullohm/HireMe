            ...
            return (
                <FullwidthLayout>
                    <div className="intro-banner dark-overlay" data-background-image="images/home-background-02.jpg">
                        ...
                        <div className="background-image-container" style={{backgroundImage: "url('images/home-background-02.jpg')"}}></div>
                    </div>
                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-xl-3 col-md-6">
                                    ...
                                    <Link to="/jobs" className={"photo-box small"}
                                       data-background-image="images/job-category-01.jpg" style={{background: "url(/images/job-category-01.jpg)", backgroundSize: "cover", backgroundPosition: "100%"}}>
                                ...
                                <div className="col-xl-3 col-md-6">
                                    ...
                                    <Link to="/jobs" className="photo-box small"
                                       data-background-image="images/job-category-02.jpg" style={{background: "url(/images/job-category-02.jpg)", backgroundSize: "cover", backgroundPosition: "100%"}}>
                                        <div className="photo-box-content">
                                ...
                                <div className="col-xl-3 col-md-6">
                                    ...
                                    <Link to="/jobs" className="photo-box small"
                                       data-background-image="images/job-category-03.jpg" style={{background: "url(/images/job-category-03.jpg)", backgroundSize: "cover", backgroundPosition: "100%"}}>
                                        <div className="photo-box-content">
                                ...
                                <div className="col-xl-3 col-md-6">
                                    ...
                                    <Link to="/jobs" className="photo-box small"
                                       data-background-image="images/job-category-04.jpg" style={{background: "url(/images/job-category-04.jpg)", backgroundSize: "cover", backgroundPosition: "100%"}}>
                                        <div className="photo-box-content">
                                ...
                                <div className="col-xl-3 col-md-6">
                                    ...
                                    <Link to="/jobs" className="photo-box small"
                                       data-background-image="images/job-category-05.jpg" style={{background: "url(/images/job-category-05.jpg)", backgroundSize: "cover", backgroundPosition: "100%"}}>
                                        <div className="photo-box-content">
                                ...
                                <div className="col-xl-3 col-md-6">
                                    ...
                                    <Link to="/jobs" className="photo-box small"
                                       data-background-image="images/job-category-06.jpg" style={{background: "url(/images/job-category-06.jpg)", backgroundSize: "cover", backgroundPosition: "100%"}}>
                                        <div className="photo-box-content">
                                ...
                                <div className="col-xl-3 col-md-6">
                                    ...
                                    <Link to="/jobs" className="photo-box small"
                                       data-background-image="images/job-category-07.jpg" style={{background: "url(/images/job-category-07.jpg)", backgroundSize: "cover", backgroundPosition: "100%"}}>
                                        <div className="photo-box-content">
                                ...
                                <div className="col-xl-3 col-md-6">
                                    ...
                                    <Link to="/jobs" className="photo-box small"
                                       data-background-image="images/job-category-08.jpg" style={{background: "url(/images/job-category-08.jpg)", backgroundSize: "cover", backgroundPosition: "100%"}}>
                                        <div className="photo-box-content">
                            ...
                            <div className="row">
                                <div className="col-xl-12">
                                    ...
                                    <div className="section-headline margin-top-0 margin-bottom-35">
                                        <h3>Recent Jobs</h3>
                                        <Link to="/jobs" className="headline-link">Browse All
                                            Jobs</Link>
                                    </div>
                            ...
                            <div className="row">
                                    ...
                                    <div className="icon-box with-line">
                                        ...
                                        <div className="icon-box-circle">
                                            <div className="icon-box-circle-inner">
                                                ...
                                                <div className="icon-box-check"><i
                                                    className="icon-material-outline-check"></i></div>
                                            </div>
                                        </div>
                                ...
                                <div className="col-xl-4 col-md-4">
                                    ...
                                    <div className="icon-box with-line">
                                        ...
                                        <h3>Post a Job</h3>
                                        <p>Efficiently unleash cross-media information without. Quickly maximize return
                                            on investment.</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-4 col-md-4">
                                    ...
                                    <div className="icon-box">
                                        ...
                                        <p>Nanotechnology immersion along the information highway will close the loop on
                                            focusing solely.</p>
                                    </div>
                                </div>
                            ...
                            <div className="testimonial-carousel testimonials">
                                ...
                                <div className="fw-carousel-review">
                                    <div className="testimonial-box">
                                        ...
                                        <div className="testimonial">Efficiently unleash cross-media information without
                                ...
                                <div className="fw-carousel-review">
                                    <div className="testimonial-box">
                                        ...
                                        <div className="testimonial">Completely synergize resource taxing relationships
                                            via premier niche markets. Professionally cultivate one-to-one customer
                                            service with robust ideas. Dynamically innovate resource-leveling customer
                                            service for state of the art.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="fw-carousel-review">
                                    <div className="testimonial-box">
                                        ...
                                        <div className="testimonial">Collaboratively administrate turnkey channels
                                            whereas virtual e-tailers. Objectively seize scalable metrics whereas
                                            proactive e-services. Seamlessly empower fully researched growth strategies
