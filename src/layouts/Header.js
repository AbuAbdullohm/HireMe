                ...
                <div id="header">
                    <div className="container">
                        ...
                        <div className="left-side">
                            ...
                            <div id="logo">
                                <Link to="/"><img src="/images/hire_logo_dark.png" alt=""/></Link>
                            </div>
                            ...
                            <nav style={{zIndex: 1001}} id="navigation">
                                <ul id="responsive">
                                    ...
                                    <li><Link to="#" className="current">Find Work</Link>
                                        <ul className="dropdown-nav">
                                            <li>
