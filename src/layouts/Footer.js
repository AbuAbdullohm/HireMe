                                        ...
                                        <div className="footer-row">
                                            <div className="footer-row-inner">
                                                <ul className="footer-social-links">
                                                    <li>
                                                        <a href="http://facebook.com/rteco.llc" title="Facebook" data-tippy-placement="bottom"
                                                           data-tippy-theme="light">
                                                            <i className="icon-brand-facebook-f"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="https://twitter.com/rteco1" title="Twitter" data-tippy-placement="bottom"
                                                           data-tippy-theme="light">
                                                            <i className="icon-brand-twitter"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="https://linkedin.com/rteco" title="LinkedIn" data-tippy-placement="bottom"
                                                           data-tippy-theme="light">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-2 col-lg-2 col-md-3">
                                <div className="footer-links">
                                    ...
                                    <ul>
                                        <li><Link to="/jobs"><span>Browse Jobs</span></Link></li>
                                        <li><Link to="/companies"><span>Browse Companies</span></Link></li>
                                        {/*<li><Link to="/resume/add"><span>Add Resume</span></Link></li>*/}
                                        {/*<li><Link to="/job/alerts"><span>Job Alerts</span></Link></li>*/}
                                        <li><Link to="/job/bookmarks"><span>My Bookmarks</span></Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-2 col-lg-2 col-md-3">
                                <div className="footer-links">
                                    ...
                                    <ul>
                                        ...
                                        <li><Link to="/signin"><span>Post a Job</span></Link></li>
                            ...
                            <div className="col-xl-2 col-lg-2 col-md-3">
                                <div className="footer-links">
                                    <h3>Account</h3>
                                    <ul>
                                        <li><Link to="#"><span>Sign in</span></Link></li>
